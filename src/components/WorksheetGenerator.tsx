...
export const WorksheetGenerator = () => {
  ...
  const additionProblems = generateAdditionProblems(15); // 15 double-digit addition problems
  const subtractionProblems = generateSubtractionProblems(15); // 15 double-digit subtraction problems

  return (
    <div className="max-w-4xl mx-auto">
      <div className="print:block">
        <div className="mb-8 print:mb-4 page-break-after-always">
